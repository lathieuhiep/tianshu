        ...
        <div class="wrap es-crawler-template-page">
            ...
            <div class="es-template-layout">
                <section class="es-template-panel es-template-form-panel">
                    ...
                    <form id="es-crawler-template-form">
                        ...
                        <div class="es-template-step">
                            <h3><span>1</span><?php esc_html_e('Thông tin truyện', 'extend-site'); ?></h3>
                            ...
                            <?php self::render_selector_field('es-template-chapter-content-selector', 'chapter_content_selector', __('Selector nội dung chương', 'extend-site')); ?>
                        ...
                        <div class="es-template-step es-template-step-chapter" id="es-template-step-chapter">
                            <h3><span>2</span><?php esc_html_e('Thông tin chương', 'extend-site'); ?></h3>
                            ...
                            <div class="es-template-two-cols">
                                <?php self::render_selector_field(
                                    ...
                                    __('Selector khối/link chương', 'extend-site'),
                                ...
                                <?php self::render_selector_field('es-template-chapter-title-selector', 'chapter_title_selector', __('Selector tên chương', 'extend-site')); ?>
                            </div>
                            <?php self::render_selector_field('es-template-toc-page-link-selector', 'toc_page_link_selector', __('Selector link phân trang mục lục', 'extend-site')); ?>
                ...
                <aside class="es-template-panel es-template-preview-panel">
                    ...
                    <div class="es-template-field">
                        <label for="es-template-target-url"><?php esc_html_e('URL truyện mẫu', 'extend-site'); ?></label>
