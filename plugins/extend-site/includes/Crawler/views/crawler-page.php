...
$create_template_url = isset($view_data['create_template_url']) ? (string)$view_data['create_template_url'] : admin_url('admin.php');
?>
<div class="wrap es-crawler-page">
    ...
    <div class="es-crawler-grid">
        <section class="es-crawler-card es-crawler-form-card">
            ...
            <div class="es-crawler-step es-crawler-template-mode">
                ...
                <div class="es-crawler-mode-toggle">
                    <label><input type="radio" name="es_crawler_mode" value="template"
                                  checked/> <?php esc_html_e('Cào bằng Template', 'extend-site'); ?></label>
                    <label><input type="radio" name="es_crawler_mode"
                                  value="manual"/> <?php esc_html_e('Cào thủ công', 'extend-site'); ?></label>
                </div>
                    ...
                    <div class="es-crawler-two-cols">
                        <div class="es-crawler-field">
                            ...
                            <select id="es-crawler-template-id"
                                    data-placeholder="<?php echo esc_attr__('Tìm template...', 'extend-site'); ?>">
                                <option value=""><?php esc_html_e('Chọn template', 'extend-site'); ?></option>
                            </select>
                            <p>
                                <a class="button button-small" href="<?php echo esc_url($create_template_url); ?>">
                        ...
                        <div class="es-crawler-field">
                            ...
                            <input type="url" id="es-crawler-story-source-url" class="regular-text"
                                   placeholder="https://example.com/truyen/abc"/>
                        </div>
                    </div>

                    <button type="button" class="button button-secondary"
                            id="es-crawler-template-prepare-btn"><?php esc_html_e('Kiểm tra queue', 'extend-site'); ?></button>
                    <div class="es-crawler-template-pattern-panel">
                        <div class="es-crawler-field">
                            <label for="es-crawler-template-url-pattern"><?php esc_html_e('URL fallback từ mẫu', 'extend-site'); ?></label>
                            <input type="text" id="es-crawler-template-url-pattern" class="regular-text" readonly
                                   placeholder="{story_url}/chuong-{chapter_number}/"/>
                            <p class="description"><?php esc_html_e('Chỉ hiển thị URL fallback từ mẫu. Khi kiểm tra queue hoặc bắt đầu, crawler ưu tiên link chương thật lấy từ mục lục.', 'extend-site'); ?></p>
                        </div>
                        ...
                        <p class="description"><?php esc_html_e('Khoảng này dùng để lọc link chương thật. Nếu không lấy được link thật, crawler dùng khoảng này với URL fallback từ mẫu.', 'extend-site'); ?></p>
                    </div>

                    <div id="es-crawler-template-prepare-status" class="es-crawler-template-prepare-status"
            ...
            <div class="es-crawler-step es-crawler-manual-panel">
                ...
                <div class="es-crawler-field">
                    ...
                    <select id="es-crawler-story" class="es-crawler-story-select"
                            data-placeholder="<?php echo esc_attr__('Tìm truyện...', 'extend-site'); ?>"></select>
                ...
                <div class="es-crawler-field">
                    ...
                    <input type="url" id="es-crawler-url-pattern" class="regular-text"
                           placeholder="https://example.com/story/chuong-{n}/"/>
                    ...
                    <p class="description"><strong><?php esc_html_e('Ví dụ URL thật:', 'extend-site'); ?></strong>
                        <code>https://truyenfull.today/toi-cuong-he-thong/chuong-1/</code></p>
                    <p class="description"><strong><?php esc_html_e('Mẫu URL cần nhập:', 'extend-site'); ?></strong>
                        <code>https://truyenfull.today/toi-cuong-he-thong/chuong-{n}/</code></p>
                </div>
            ...
            <div class="es-crawler-step">
                ...
                <div class="es-crawler-two-cols">
                    <div class="es-crawler-field">
                        ...
                        <select id="es-crawler-title-mode">
                            <option value="number"
                                    selected><?php esc_html_e('Chỉ dùng Chương {n}', 'extend-site'); ?></option>
                    ...
                    <div class="es-crawler-field es-crawler-title-template-field is-hidden">
                        ...
                        <input type="text" id="es-crawler-title-template" class="regular-text"
                               value="{story} - Chương {n}: {source_title}"/>
                        ...
                        <p class="description"><strong><?php esc_html_e('Ví dụ:', 'extend-site'); ?></strong> <code>{story}
                                - Chương {n}: {source_title}</code></p>
                    </div>
                </div>
                ...
                <div class="es-crawler-two-cols">
                    ...
                    <div class="es-crawler-field">
                        ...
                        <input type="url" id="es-crawler-preview-url" class="regular-text"
                               placeholder="<?php echo esc_attr__('Không bắt buộc: ghi đè URL xem thử tự động', 'extend-site'); ?>"/>
                        <p class="description"><?php esc_html_e('Nút Xem thử sẽ dùng URL này. Với Template, URL sẽ được tự điền từ danh sách chương sau khi kiểm tra queue.', 'extend-site'); ?></p>
                    </div>
                </div>
            </div>
            ...
            <details class="es-crawler-step es-crawler-advanced">
                ...
                <div class="es-crawler-two-cols">
                    <div class="es-crawler-field">
                        ...
                        <textarea id="es-crawler-find" rows="5"
                    ...
                    <div class="es-crawler-field">
                        ...
                        <textarea id="es-crawler-replace" rows="5"
        ...
        <aside class="es-crawler-card es-crawler-status-card">
            <div class="es-crawler-sidebar-actions">
                ...
                <div class="es-crawler-actions">
                    <button type="button" class="button"
                            id="es-crawler-preview-btn"><?php esc_html_e('Xem thử', 'extend-site'); ?></button>
                    <button type="button" class="button es-crawler-manual-action"
                            id="es-crawler-generate-btn"><?php esc_html_e('Tạo danh sách URL', 'extend-site'); ?></button>
                    <button type="button" class="button button-primary"
                            id="es-crawler-start-btn"><?php esc_html_e('Bắt đầu', 'extend-site'); ?></button>
                    <button type="button" class="button" id="es-crawler-pause-btn"
                            disabled><?php esc_html_e('Tạm dừng', 'extend-site'); ?></button>
                    <button type="button" class="button" id="es-crawler-stop-btn"
                            disabled><?php esc_html_e('Dừng', 'extend-site'); ?></button>
                    <button type="button" class="button button-secondary is-hidden"
                            id="es-crawler-finalize-btn"><?php esc_html_e('Hoàn tất lại', 'extend-site'); ?></button>
                </div>
                <ul class="es-crawler-action-help">
                    <li>
                        <strong><?php esc_html_e('Xem thử:', 'extend-site'); ?></strong> <?php esc_html_e('Kiểm tra 1 URL, không tạo chương.', 'extend-site'); ?>
                    </li>
                    <li class="es-crawler-manual-action">
                        <strong><?php esc_html_e('Tạo URL:', 'extend-site'); ?></strong> <?php esc_html_e('Sinh danh sách trước khi crawl.', 'extend-site'); ?>
                    </li>
                    <li>
                        <strong><?php esc_html_e('Bắt đầu:', 'extend-site'); ?></strong> <?php esc_html_e('Chạy tuần tự từng URL.', 'extend-site'); ?>
                    </li>
                </ul>
            </div>
            ...
            <div class="es-crawler-sidebar-progress">
                ...
                <div class="es-crawler-progress"
                     aria-label="<?php echo esc_attr__('Tiến độ crawler', 'extend-site'); ?>">
    ...
    <div class="es-crawler-panels">
        <section class="es-crawler-card">
            ...
            <div id="es-crawler-url-summary"
                 class="es-crawler-url-summary"><?php esc_html_e('Chưa tạo URL nào.', 'extend-site'); ?></div>
            <textarea id="es-crawler-url-list" readonly rows="8"></textarea>
        </section>

        <section class="es-crawler-card">
            <h2><?php esc_html_e('Kết quả xem thử', 'extend-site'); ?></h2>
            <div id="es-crawler-preview-result"
                 class="es-crawler-preview-result"><?php esc_html_e('Chưa có kết quả xem thử.', 'extend-site'); ?></div>
        </section>
        ...
        <section class="es-crawler-card es-crawler-log-card">
            <div class="es-crawler-log-header">
                ...
                <button type="button" class="button"
                        id="es-crawler-copy-log-btn"><?php esc_html_e('Sao chép nhật ký', 'extend-site'); ?></button>
            </div>
    ...
    <div class="es-crawler-help-modal is-hidden" id="es-crawler-help-modal" aria-hidden="true">
        ...
        <div class="es-crawler-help-dialog" role="dialog" aria-modal="true" aria-labelledby="es-crawler-help-title">
            <button type="button" class="es-crawler-help-close" data-es-crawler-help-close
                    aria-label="<?php echo esc_attr__('Đóng hướng dẫn', 'extend-site'); ?>">×
            </button>
            ...
            <div class="es-crawler-help-section">
                ...
                <ol class="es-crawler-help-steps">
                    <li><strong><?php esc_html_e('Chọn truyện cần thêm chương', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Chọn truyện đã có trong website. Crawler sẽ thêm chương mới vào truyện này và bỏ qua chương trùng.', 'extend-site'); ?></p>
                    </li>
                    <li><strong><?php esc_html_e('Nhập Mẫu URL có {n}', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Thay số chương thật bằng {n}. Ví dụ URL thật là /chuong-1/ thì mẫu URL là /chuong-{n}/.', 'extend-site'); ?></p>
                    </li>
                    <li><strong><?php esc_html_e('Tạo danh sách URL', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Nhập Từ, Đến và Đệm số nếu cần, sau đó bấm Tạo danh sách URL trước khi bắt đầu.', 'extend-site'); ?></p>
                    </li>
                </ol>
            </div>
            ...
            <div class="es-crawler-help-section">
                ...
                <ol class="es-crawler-help-steps">
                    <li><strong><?php esc_html_e('Chọn template và URL trang truyện', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Template sẽ bóc thông tin truyện, ảnh bìa, tác giả, thể loại và danh sách link chương từ trang truyện nguồn.', 'extend-site'); ?></p>
                    </li>
                    <li><strong><?php esc_html_e('Kiểm tra queue', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Hệ thống sẽ quét thử thông tin truyện và danh sách chương để hiển thị tóm tắt trước khi chạy.', 'extend-site'); ?></p>
                    </li>
                    <li><strong><?php esc_html_e('Kiểm tra URL xem thử đang dùng', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Sau khi kiểm tra queue, URL xem thử sẽ tự điền bằng URL chương đầu tiên. Có thể sửa URL này để test chương khác.', 'extend-site'); ?></p>
                    </li>
                </ol>
            </div>
            ...
            <div class="es-crawler-help-section">
                ...
                <ol class="es-crawler-help-steps">
                    <li><strong><?php esc_html_e('Xem thử nội dung', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Kiểm tra tiêu đề sẽ lưu, độ dài nội dung, nội dung preview và các cảnh báo nếu có.', 'extend-site'); ?></p>
                    </li>
                    <li><strong><?php esc_html_e('Chạy thử bằng bản nháp', 'extend-site'); ?></strong>
                        <p><?php esc_html_e('Khi test nguồn mới, nên chọn Bản nháp và chạy ít chương trước. Nếu nội dung ổn mới chạy batch lớn hoặc xuất bản.', 'extend-site'); ?></p>
                    </li>
                </ol>
            </div>
